...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _FButtonTabBarState tabBar;
...
/// Design widget that displays a horizontal row of tabs.
class FButtonTabBar extends StatefulWidget
  ...
  /// and the entire [FButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  @override
  State<FButtonTabBar> createState() =>
      _FButtonTabBarState();
}

class _FButtonTabBarState extends State<FButtonTabBar>
  ...
  @override
  void didUpdateWidget(FButtonTabBar oldWidget) {
