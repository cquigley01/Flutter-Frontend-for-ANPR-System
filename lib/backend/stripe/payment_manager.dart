...
const _kProdStripePublishableKey =
    'pk_live_51NSplEG1BXta68VnsWnZBxm6yFC8H4cuf567ypzc0Z2unValxqTtchbrXGw9ZcwEbgkXtgawLF9fIM8rCvYmaTEU0077mYvCRA';
const _kTestStripePublishableKey =
    'pk_test_51NSplEG1BXta68VnIjoOX1KieYYQuwdAZcrQJ8cGGxKQrJYUqpCOJDSR2rud4yYKcMvs6H6J29dFhYF3W1tQX4TC00nXFLDqt8';
const _kAppleMerchantId = 'merchant.com.mycompany.parkit';
  ...
  try {
    ...
    await Stripe.instance.initPaymentSheet(
      paymentSheetParameters: SetupPaymentSheetParameters(
        ...
        merchantDisplayName: 'CianQuigley',
...
Future<StripePaymentResponse> showWebPaymentSheet(
  ...
  buttonColor = buttonColor ?? FFTheme.of(context).primary;
